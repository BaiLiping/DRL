...
class algs(object):
    ...
    def acceleration_with_weights(self):
        reward_memory=[]
        for i_episode in range(self.episodes):
            ...
            s_with_acceleration=[]
            weight=[0.3,0.1,0.5,0.3,0.5,.1,.5,.3]
            for i in range(4):
            ...
            for step in range(180):
                ...
                for i in range(4):
                    s_with_acceleration_new.append(weight[i]*(s_[i]-s_with_acceleration[2*i]))
                    s_with_acceleration_new.append(weight[2*i]*s_[i])
